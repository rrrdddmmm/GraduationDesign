...
public interface ConfigStr {
	...
	public static String	defaultTaskview				= "默认任务：本系统默认任务终期成果视屏上传";
	public static String	defaultTaskviewResultFile	= netPathAbs + "default.mp4";
	public static String	defaultTaskTXTResultFile	= ResourcesPath + "default.txt";
	public static String	videodefaultimage			= netPathAbs + "videodefault.jpg";
}
