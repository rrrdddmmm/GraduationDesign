...
<body>
	<h1 class="globle_title2">
		<img src="../content/images/tag.gif" /> 配置信息列表 <em></em>
	</h1>
	<div class="syt_lb"></div>
	<div class="globle_bck">
		<h1 class="diandianb">
			:: 配置信息列表 ::<a href="configAdd.do?flage=${flage }&handle=1"> <img
				...
				<c:forEach items="${configlist }" var="li" varStatus="idxStatus">
					<c:if test="${idxStatus.index%2==1 }">
					 ...
					 <tr class="lantr" data-itemid="${li.id }">
						...
						<td><fmt:formatDate value="${li.updatetime }"
								pattern="yyyy-MM-dd" /></td>
						...
						<td><a
							href="configAdd.do?flage=${flage }&name=${li.name }&state=${li.state }&id=${li.id }&handle=2">修改</a>&nbsp;&nbsp;/&nbsp;&nbsp;
